...
try {
  ...
  const report = {
    ...
    event: { title: fields.title, start: fields.start, end: fields.end, timezone: fields.timezone,
      venue: fields.venue, location: fields.location, rsvp: fields.rsvp, sourceEvidence: result.sourceEvidence, birthdayAge: fields.birthdayAge, category: result.category },
  ...
  await writeFile("artifacts/snap-ocr-luna-2026-09-05.json", JSON.stringify(report, null, 2));
