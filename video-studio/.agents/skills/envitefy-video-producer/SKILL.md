...
4. Follow the mandatory [brand pronunciation standard](../../../../ENVITEFY_BRAND.md): **en-VITE-fy**, approximately **/ɛnˈvaɪtfaɪ/**, continuously, with no extra syllable. Include its complete model direction or equivalent supported pronunciation controls for every spoken brand occurrence. Use the shared audio helper for TTS and native dialogue direction. Review every generated occurrence against the written standard; transcription alone does not prove pronunciation. Keep visible branding spelled Envitefy. Generate/select assets and sound with continuity within the campaign and fresh art direction for new campaigns. Keep source media, prompts, selected takes, and provider job state together. Check a short voice sample when selecting a new voice.
