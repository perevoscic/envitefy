...
4. The spoken name is **Inviteefy**, exact IPA **/ɪnˈvaɪtiˌfaɪ/**. Use `<phoneme alphabet="ipa" ph="ɪnˈvaɪtiˌfaɪ">Envitefy</phoneme>` in SSML-capable speech engines. Preserve primary stress on VY and secondary stress on fy; do not add the old vowel-length mark or discard the secondary stress. Speak it as one word. Written branding remains Envitefy. Use the shared audio helper for TTS and native dialogue direction. Audition the selected voice; transcription alone does not prove pronunciation. Generate/select assets and sound with continuity within the campaign and fresh art direction for new campaigns. Keep source media, prompts, selected takes, and provider job state together. Check a short voice sample when selecting a new voice.
