  ...
  return (
    <AbsoluteFill>
      ...
      <Sequence from={60} durationInFrames={18} name="Extract event details">
        <DemoV3 name="processing" caption="Snap it." />
      </Sequence>
      <Sequence from={78} durationInFrames={15} name="Digital invitation">
        <DemoV3 name="event" caption="The party. All here." />
      </Sequence>
      <Sequence
        from={93}
        durationInFrames={51}
      ...
      <Sequence from={144} durationInFrames={24} name="Copy event link">
        <DemoV3 name="share" caption="Share it." />
      </Sequence>
      <Sequence from={168} durationInFrames={30} name="Share with other parent">
        <DemoV3 name="message" caption="Share it." sub="Illustrative message" />
      </Sequence>
      <Sequence from={198} durationInFrames={36} name="Calendar options">
        <DemoV3 name="calendar" caption="Add it to your calendar." />
      </Sequence>
      <Sequence from={234} durationInFrames={24} name="Confirm calendar save">
        <DemoV3 name="calendar-add" caption="Add it to your calendar." />
      </Sequence>
...
export function FridgeFreedomV3() {
  return (
    <AbsoluteFill
      style={{
    ...
    >
      <Audio src={staticFile("projects/fridge-freedom/v3-final-mix.wav")} />
      ...
      <Sequence from={660} durationInFrames={150} name="Clear the fridge">
        <Video
          objectFit="cover"
          src={asset("v3-ending-edit.mp4")}
          muted
          style={{ width: "100%", height: "100%" }}
        />
      </Sequence>
      <Sequence from={810} durationInFrames={90} name="Keep the memories">
        <FridgePayoff source="v3-ending-edit.mp4" trimBefore={150} />
      </Sequence>
    </AbsoluteFill>
  );
}
