...
const source='public/projects/john-space-disco/vo-create-v10.mp3';
const resultPath='projects/john-space-disco/brand-standard-voice-v10-audio-review.json';
const requestPath='projects/john-space-disco/brand-standard-voice-v10-audio-review-request.json';
...
if(sha256!=='2668b947553c630dfc0deda5b85484a21a40764cd9017919e59fe7aa02bacab5')throw Error('The verified synthetic stock-voice file changed.');
const tts=JSON.parse(await fs.readFile('projects/john-space-disco/voice-create-v10-request.json','utf8'));
