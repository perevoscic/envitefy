...
for(const name of process.argv.slice(2)){
 const data=await fs.readFile(`public/projects/fridge-freedom/${name}.mp4`);
 ...
 await fs.writeFile(`projects/fridge-freedom/${name}-media-review.json`,text);console.log(name,text);
}
