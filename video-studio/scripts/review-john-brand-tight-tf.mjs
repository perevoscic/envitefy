...
const source='public/projects/john-space-disco/vo-create-v8-tight-tf.wav';
const resultPath='projects/john-space-disco/brand-standard-voice-v8-tight-tf-audio-review.json';
const requestPath='projects/john-space-disco/brand-standard-voice-v8-tight-tf-audio-review-request.json';
...
if(sha256!=='999ecace7b782cfee89c37d82ff2e7e7ff857fd3cfceb404ba61140f2b9eb0ec')throw Error('The verified synthetic stock-voice file changed.');
