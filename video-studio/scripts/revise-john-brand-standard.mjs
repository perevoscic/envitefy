...
const b='public/projects/john-space-disco/',o='out/john-space-disco/',p='projects/john-space-disco/',voice='vo-create-v12.mp3';
const review=JSON.parse(fs.readFileSync(p+'brand-standard-voice-v12-audio-review.json','utf8'));
if(!review.review.matchesStandard||review.review.brand_ipa!=='/ɛnˈvaɪtfaɪ/'||review.review.syllable_count!==3)throw Error('Pronunciation review failed');
...
for(const r of revisions){
 ...
 records.push({...r,base,output,mix,voice:b+voice,voiceSha256:voiceHash,voiceDurationSeconds:duration,audioReview:p+'brand-standard-voice-v12-audio-review.json',status:'exported-awaiting-final-checks'});console.log('Exported '+output);
}
