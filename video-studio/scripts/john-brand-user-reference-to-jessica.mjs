...
const source='public/projects/john-space-disco/vo-create-user-reference-sapi.wav',output='public/projects/john-space-disco/vo-create-jessica-user-reference-v1.mp3',record='projects/john-space-disco/voice-jessica-user-reference-v1-request.json';
...
if(sha256!=='ac2b2eb837dbb69b1cf041c9e3f0aed2f830c03bbd9f114604bced4dfa8de4f2')throw Error('Local synthetic reference changed');
const userReference=JSON.parse(await fs.readFile('projects/john-space-disco/user-pronunciation-reference-audio-review.json','utf8'));if(userReference.review.ipa!=='ɪnˈvaɪtɪfaɪ')throw Error('Reference phonemes changed');
...
const provenance={source,sourceSha256:sha256,sourceBytes:bytes.length,sourceType:'Locally generated Microsoft Zira stock speech with exact IPA /ɪnˈvaɪtɪfaɪ/. Not a human recording.',voice,model,voiceSettings,script:'Bring their birthday ideas to life with Envitefy Concierge.',pronunciation:'in-VY-tih-fy',output};
