...
if(phase==='audio'){
 const clips=[['planner-open',0,1.3,.65],['planner-reveal',4.5,3.5,1.3],['dancer-dance',9.6,2.8,.7],['crier-open-v3',12.4,.8,.7],['crier-tissue-v3',13.9,3.6,.8],['planner-payoff',17.5,1.2,.5],['dancer-payoff',18.7,1.4,.65],['crier-payoff',20.1,1.2,.65]];
 ...
 ff([...inputs,'-filter_complex',filters.join(';'),'-map','[out]','-ac','2','-c:a','pcm_s16le',base+'final-mix-v3.wav']);
}
