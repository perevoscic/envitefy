...
const source='public/projects/john-space-disco/vo-create-jessica-reference-v1.mp3';
const resultPath='projects/john-space-disco/brand-jessica-reference-v1-audio-review.json';
const requestPath='projects/john-space-disco/brand-jessica-reference-v1-audio-review-request.json';
...
if(sha256!=='d1d7dfeda93b0075122a391f9782d5ca502f303fb3855ae7283092c666865212')throw Error('The verified synthetic stock-voice file changed.');
const tts=JSON.parse(await fs.readFile('projects/john-space-disco/voice-jessica-reference-v1-request.json','utf8'));
if(tts.status!=='completed'||tts.voice!=='Jessica'||tts.script!=='Bring their birthday ideas to life with Envitefy Concierge.')throw Error('Synthetic narration provenance mismatch.');
...
const provenance={source,sha256,bytes:bytes.length,scope:'Only a freshly generated stock Jessica converted from a local exact-IPA stock synthetic reference adult TTS voice saying the user-provided promotional sentence. No personal recordings, child/parent dialogue, soundtrack, customer data or video included.',model,destination,prompt};
