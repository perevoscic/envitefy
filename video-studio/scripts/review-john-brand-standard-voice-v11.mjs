...
const source='public/projects/john-space-disco/vo-create-v11.mp3';
const resultPath='projects/john-space-disco/brand-standard-voice-v11-audio-review.json';
const requestPath='projects/john-space-disco/brand-standard-voice-v11-audio-review-request.json';
...
if(sha256!=='7d113ec3a56f5f1c8d2ed5a821f431ac6a372c9a82616fd2f743a0d97c5aca45')throw Error('The verified synthetic stock-voice file changed.');
const tts=JSON.parse(await fs.readFile('projects/john-space-disco/voice-create-v11-request.json','utf8'));
if(tts.status!=='completed'||tts.voice!=='Jessica'||tts.body.text!=='Bring their birthday ideas to life with "/ˌɛnˈvaɪt.faɪ/" Concierge.')throw Error('Synthetic narration provenance mismatch.');
