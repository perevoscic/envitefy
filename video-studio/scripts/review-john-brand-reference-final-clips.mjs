...
const statePath='projects/john-space-disco/brand-reference-final-clips-review-request.json',resultPath='projects/john-space-disco/brand-reference-final-clips-audio-review.json';
...
for(const r of revisions.records){
 if(r.voice!=='public/projects/john-space-disco/vo-create-jessica-reference-v1.mp3'||r.start<5.3||r.start+r.voiceDurationSeconds+.25>12)throw Error('Unexpected review clip source');
