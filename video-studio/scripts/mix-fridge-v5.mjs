...
const shutterTimes=[(timing.mainStartFrame+captureFrame)/timing.fps];
...
ff(['-i',base+'music.mp3','-i',base+'v2-opening-edit.mp4','-i',base+'v2-ending-edit.mp4','-i',base+'v5-effects.wav','-filter_complex',mix,'-map','[a]','-ar','48000','-ac','2','-c:a','pcm_s16le',base+'v5-final-mix.wav']);console.log('V5 audio synchronized.');
