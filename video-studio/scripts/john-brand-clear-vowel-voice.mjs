...
const body={text:toSpeechText(texts[mode],model).replace('/ɛnˈvaɪtfaɪ/','/ˌɛnˈvaɪt.faɪ/'),model_id:model,voice_settings:{stability:model==='eleven_v3'?0.5:0.40,similarity_boost:0.75,style:0.22,use_speaker_boost:true,speed:1.08}};
