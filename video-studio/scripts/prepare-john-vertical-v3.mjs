...
// The source reverses screen positions at frame 60 (28 seconds on the master).
// Correct only that camera shot; keep the original native dialogue timing.
ff(['-i',b+'vertical-payoff.mp4','-vf',"hflip=enable='gte(n,60)'",'-an','-c:v','libx264','-preset','slow','-crf','16','-pix_fmt','yuv420p',b+'vertical-payoff-v3.mp4']);
...
ff(['-i',b+'music.mp3','-i',b+'hook.mp4','-i',b+'update.mp4','-i',b+'payoff.mp4','-i',b+'vo-create-v3.mp3','-i',b+'vo-update.mp3','-i',b+'vertical-effects.wav','-filter_complex',filter,'-map','[a]','-ar','48000','-ac','2','-c:a','pcm_s16le',b+'vertical-final-mix-v3.wav']);
console.log('Prepared V3 pronunciation and ending correction.');
