...
const source='public/projects/john-space-disco/vo-create-brand-standard-v1.wav';
const resultPath='projects/john-space-disco/brand-directed-voice-v1-audio-review.json';
const requestPath='projects/john-space-disco/brand-directed-voice-v1-audio-review-request.json';
...
if(sha256!=='fcb483da5cfe531b9ec82316968d839cc52815d028b8ef0acc6f61498fd86a1b')throw Error('The verified synthetic stock-voice file changed.');
const tts=JSON.parse(await fs.readFile('projects/john-space-disco/vo-create-brand-standard-v1-request.json','utf8'));
