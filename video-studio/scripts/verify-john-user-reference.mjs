...
const p='projects/john-space-disco/',data=JSON.parse(fs.readFileSync(p+'user-reference-revision.json','utf8')),reports=[];
...
fs.writeFileSync(p+'user-reference-export-verification.json',JSON.stringify({date:new Date().toISOString(),reports},null,2)+'\n');
