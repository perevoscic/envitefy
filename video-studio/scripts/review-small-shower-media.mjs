...
for(const name of process.argv.slice(2)){
 const data=await fs.readFile(`public/projects/small-shower/${name}.mp4`);
 ...
 await fs.writeFile(`projects/small-shower/${name}-media-review.json`,text);console.log(name,text);
}
