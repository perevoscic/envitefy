...
const source='public/projects/john-space-disco/vo-create-v9.mp3';
const resultPath='projects/john-space-disco/brand-standard-voice-v9-pro-audio-review.json';
const requestPath='projects/john-space-disco/brand-standard-voice-v9-pro-audio-review-request.json';
...
if(sha256!=='28f0c8cf3b04504d0edfdf94144f231a594fef82435ea9e22f05c16d5ee78ca1')throw Error('The verified synthetic stock-voice file changed.');
const tts=JSON.parse(await fs.readFile('projects/john-space-disco/voice-create-v9-request.json','utf8'));
if(tts.status!=='completed'||tts.voice!=='Jessica'||tts.body.text!=='Bring their birthday ideas to life with "/ɛnˈvaɪtfaɪ/" Concierge.')throw Error('Synthetic narration provenance mismatch.');
