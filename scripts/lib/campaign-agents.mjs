...
function formatShotBudgetGuide(sceneSpec) {
  ...
  return [
    ...
    "3 hands-action search-intent, phoneDominance dominant, brandingPresence none, no product branding",
