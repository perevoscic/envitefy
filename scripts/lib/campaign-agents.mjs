...
export const ART_DIRECTION_SYSTEM_PROMPT =
  "You are the Creative Director for a short-form ad made from still images. Convert the brief, persona, and critique into storyboard locks plus explicit variation rules. Separate fixed continuity details from allowed variation. Every lock must be specific enough that a different illustrator could redraw any frame and keep the same person, outfit, props, room layout, phone, lighting, style, and framing baseline. But do not freeze the campaign into one repeated composition. Lock identity, wardrobe, room, product, invite design, lighting direction, and brand tone. Brand colors are accents unless the user explicitly asks for a monochrome palette: if the brief says slightly purple/lavender branded, keep wardrobe, phone case, curtains, towels, mugs, pillows, vases, notes, and home decor mostly neutral, and use purple/lavender mainly as one or two small accents or inside the product screen. Do not lock one chest-level phone pose, one centered stance, or one medium close-up across the whole sequence. Favor candid, observational, believable camera language over posed product-demo photography. The subject should usually seem unaware of the camera, as if captured naturally from the side, three-quarter rear, over-the-shoulder, or in passing, not performing for the lens. Decide which props prove chaos, which props prove resolution, which props are disallowed, and what exact product proof must be visible on screen. Preserve user overrides. Preserve the user's vertical and story intent over any defaults: a birthday invite delay campaign must not become gymnastics, sports, dance, or an activity-venue campaign unless the user explicitly requested that. For birthday campaigns, place the scene before the party, keep the home clean and ordinary, avoid completed party setups unless explicitly requested, and make the final proof the digital Envitefy live card or share result. Delay proof must be digital: phone notification, email, browser order-status page, or search result. Do not invent handoff scenes, offline delay props, or extra tabletop planning props unless the user explicitly requests them. Do not build the first four frames as the same seated table scene. Use distinct beats and blocking: phone alert, laptop/email or order-status proof, search intent, product entry, product proof, reaction, social proof, send proof, relief, final payoff. Phones must be physically held by visible fingers or lying flat screen-up on a table/counter with the display visible; every visible phone must have a believable hand grip or full surface support.";
...
function formatShotBudgetGuide(sceneSpec) {
  ...
  const maps = {
    5: [
      ...
      "3 phone-proof, phoneDominance dominant, brandingPresence screen",
      "4 reaction, phoneDominance none or secondary, brandingPresence none or subtle",
      "5 final-hero, phoneDominance none, brandingPresence none",
      "Only frame 3 should be phone-dominant. Frame 5 must be final-hero, non-phone-dominant, and must not describe a phone screen, search, typing, tapping, scrolling, held-phone proof, graphic logo, standalone logo, CTA card, or text-only end card.",
    ],
    6: [
      "1 wide-environment, phoneDominance none, brandingPresence none",
      "2 environment-detail, phoneDominance none, brandingPresence none",
      "3 hands-action product-entry, phoneDominance dominant, brandingPresence subtle or screen",
      "4 reaction, phoneDominance none, brandingPresence none",
      "5 phone-proof, phoneDominance dominant, brandingPresence screen",
      "6 final-hero, phoneDominance none, brandingPresence none",
      "Only frames 3 and 5 should be phone-dominant. Frame 6 must be final-hero, non-phone-dominant, and must not describe a phone screen, search, typing, tapping, scrolling, held-phone proof, graphic logo, standalone logo, CTA card, or text-only end card.",
    ],
    7: [
      "1 wide-environment, phoneDominance none, brandingPresence none",
      "2 environment-detail, phoneDominance none, brandingPresence none",
      ...
      "4 reaction, phoneDominance none, brandingPresence none",
      "5 phone-proof, phoneDominance dominant, brandingPresence screen",
      "6 social-proof, phoneDominance none or secondary, brandingPresence none or subtle",
      "7 final-hero, phoneDominance none, brandingPresence none",
      "Only frames 3 and 5 should be phone-dominant. Frame 6 social-proof must not be another phone demo. Frame 7 must be final-hero, non-phone-dominant, and must not describe a phone screen, search, typing, tapping, scrolling, held-phone proof, graphic logo, standalone logo, CTA card, or text-only end card.",
    ],
    8: [
      "1 wide-environment, phoneDominance none, brandingPresence none",
      "2 environment-detail, phoneDominance none, brandingPresence none",
      ...
      "7 phone-proof, phoneDominance dominant, brandingPresence screen",
      "8 final-hero, phoneDominance none, brandingPresence none",
      "Only frames 3, 5 and 7 should be phone-dominant. Frame 8 must be final-hero, non-phone-dominant, and must not describe a phone screen, search, typing, tapping, scrolling, held-phone proof, graphic logo, standalone logo, CTA card, or text-only end card.",
    ],
    9: [
      "1 wide-environment, phoneDominance none, brandingPresence none",
      "2 environment-detail, phoneDominance none, brandingPresence none",
      ...
      "6 reaction, phoneDominance none, brandingPresence none",
      "7 phone-proof, phoneDominance dominant, brandingPresence screen",
      "8 social-proof, phoneDominance none or secondary, brandingPresence none or subtle",
      "9 final-hero, phoneDominance none, brandingPresence none",
      "Only frames 3, 5 and 7 should be phone-dominant. Frame 8 social-proof must not be another phone demo. Frame 9 must be final-hero, non-phone-dominant, and must not describe a phone screen, search, typing, tapping, scrolling, held-phone proof, graphic logo, standalone logo, CTA card, or text-only end card.",
    ],
    10: [
      "1 wide-environment, phoneDominance none, brandingPresence none",
      "2 environment-detail, phoneDominance none, brandingPresence none",
      "3 hands-action search-or-product-entry, phoneDominance dominant, brandingPresence none or subtle",
      "4 over-shoulder, phoneDominance none, brandingPresence none",
      "5 phone-proof, phoneDominance dominant, brandingPresence screen",
      "6 reaction, phoneDominance none, brandingPresence none",
      ...
      "Only frames 3, 5 and 8 should be phone-dominant. Frame 7 social-proof must not be another phone demo. Frame 10 must be final-hero, non-phone-dominant, and must not describe a phone screen, search, typing, tapping, scrolling, held-phone proof, graphic logo, standalone logo, CTA card, or text-only end card.",
    ],
  };
...
export async function runArtDirectionAgent({ client, model, campaignInput, brief, persona, critique }) {
  return runStructuredStage({
    ...
    userLines: [
      ...
      "Color discipline: brand colors are accent-only unless explicitly requested as a full palette. Do not make the outfit, phone case, curtains, towels, mug, pillows, vase, notes, and UI all the same purple/lavender. Keep home and wardrobe neutral, with one or two subtle brand-color accents.",
...
export async function runCoordinatorAgent({
  ...
  return runStructuredStage({
    ...
    userLines: [
      ...
      "Classify any Google search, search results, phone screen close-up, mobile UI close-up, app screen, typing/tapping/scrolling phone, or held-phone proof frame as phoneDominance dominant. Do not label those frames secondary.",
      ...
      "Use disallowedPropRisk only when the frame violates or risks violating scene-spec prop rules, such as introducing a tablet when tablets are disallowed. If there is no risk, return an empty string, never 'none', 'n/a', or 'no risk'.",
