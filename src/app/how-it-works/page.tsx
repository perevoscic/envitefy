...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How Envitefy Works",
    description: "Turn flyers into clean event details and publish gymnastics meet pages.",
    ...
    <main className="min-h-screen w-full bg-transparent text-foreground">
      <section className="max-w-5xl mx-auto px-6 pt-10">
        ...
        <p className="mt-3 text-center text-[#5a5377]">
          From Snap capture to Gymnastics meet pages, Envitefy keeps event details clean and
          shareable.
        </p>
      </section>
      <HowItWorks />
      <Script id="ld-breadcrumb-how" type="application/ld+json" strategy="afterInteractive">
