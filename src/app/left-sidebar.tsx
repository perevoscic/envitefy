...
export default function LeftSidebar() {
  ...
  return (
    <>
      {!isCollapsed && (
        <div
          className="hidden md:block fixed inset-0 z-[190] bg-black/40 backdrop-blur-[1px]"
          aria-hidden="true"
          onClick={() => {
            setIsCollapsed(true);
      ...
      <aside
        className={`hidden md:flex fixed inset-y-0 left-0 z-[200] ${
          isCollapsed ? "md:w-16" : "md:w-64 lg:w-72"
        } flex-col border-r border-border bg-surface/60 h-full overflow-y-auto overflow-x-visible transition-[width] duration-200`}
      >
          ...
          <div className="px-3 py-4 border-t border-border space-y-2">
            <div className="relative">
              ...
              {isUserMenuOpen && (
                <div
                  id="user-menu"
                  className="absolute bottom-full left-0 mb-1 w-full rounded-lg border border-border bg-surface/90 shadow-lg overflow-visible z-[1000]"
                  role="menu"
                >
                  <Link
                    href="/settings"
                  ...
                  <div className="relative">
                    ...
                    {isResourcesOpen && (
                      <div
                        ...
                        className="absolute overflow-visible right-0 top-0 ml-2 w-56 rounded-lg border border-border bg-surface/95 shadow-lg overflow-hidden z-[1000]"
                        role="menu"
                      >
                        <Link
                          href="/about"
