...
export default function ChatProductPreview({
  ...
  return (
    ...
    >
      <div className="flex h-full min-h-0 flex-col px-4 pb-24 pt-4 sm:px-6 sm:pb-8">
        <div className="flex min-h-0 flex-1 flex-col gap-5 overflow-hidden pb-5">
          ...
          <section className="relative mx-auto flex min-h-0 w-full flex-1 items-center justify-center [container-type:size]">
            <div
          ...
          <div className="shrink-0 space-y-3">
            {publicHref ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex h-12 w-full max-w-none items-center justify-center gap-2 rounded-2xl bg-[#197052] px-5 text-sm font-bold text-white shadow-lg shadow-[#197052]/15 transition hover:bg-[#145f46]"
              >
              ...
              <button
                ...
                onClick={onGenerate}
                className="flex h-12 w-full max-w-none items-center justify-center gap-2 rounded-2xl bg-[#7c4dff] px-5 text-sm font-bold text-white shadow-lg shadow-[#7c4dff]/20 transition hover:bg-[#6f43f0] disabled:cursor-not-allowed disabled:bg-[#d8caff] disabled:shadow-none"
              >
