...
export const useCasePages = [
  {
    ...
    path: "/weddings",
    navLabel: "Weddings",
    eyebrow: "Haute couture digital stationery",
    ...
    preview: {
      ...
      chips: ["Registry", "Itinerary", "Live RSVP"],
    },
    features: [
      {
        icon: "ticket",
      ...
      {
        icon: "heart",
        title: "Bespoke Invitation Suites",
        body: "Personalize names, dates, venues, and aesthetic themes with haute couture digital stationery.",
      },
      {
        icon: "gift",
        title: "Registry & Fund Linkage",
        body: "Integrate Zola, Honeyfund, Bloomingdale's, or Crate & Barrel into your guest experience suite.",
      },
      {
        icon: "calendar",
        title: "Meal & Dietary Tracking",
        body: "Compile entrée selections, allergies, and seating assignments with precise caterer-ready reports.",
      },
    ],
    steps: [
      {
    ...
    audience: ["Couples", "luxury planners", "destination hosts", "families managing guest lists"],
    faqs: [
      {
