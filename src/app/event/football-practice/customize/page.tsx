...
const config = {
  ...
  categoryLabel: "Football Practice",
  defaultHero:
    "https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?auto=format&fit=crop&w=1800&q=80",
  detailFields: [
    // === TIMING (Parents' #1 need) ===
    { key: "endTime", label: "Practice Ends", placeholder: "6:30 PM" },
    {
      key: "arrivalTime",
      label: "Arrive By",
      placeholder: "15 min before start",
    },
    ...
    { key: "team", label: "Team / Squad", placeholder: "Varsity Panthers" },
    {
      key: "practiceType",
      label: "Practice Type",
      placeholder: "Full Pads / Shells / Helmets Only / No Contact",
    },
    {
      key: "positionGroups",
      label: "Who's Practicing",
      placeholder: "Full team, or e.g., O-Line focus",
    },
    ...
    // === LOCATION ===
    {
      ...
      placeholder: "Practice Field A (behind main stadium)",
    },
    {
      key: "dropoff",
      label: "Drop-off / Pickup",
      placeholder: "North parking lot gate",
    },
    ...
    // === WHAT TO BRING ===
    {
      ...
      placeholder: "Full pads, mouthguard, cleats, dark jersey",
    },
    {
      key: "hydration",
      label: "Hydration",
      placeholder: "Bring 2 filled water bottles (refill station available)",
    },
    ...
    // === FOCUS ===
    {
      ...
      placeholder: "Red zone reps, 7-on-7 passing, conditioning",
      type: "textarea",
    },

    // === STAFF & SAFETY ===
    { key: "coach", label: "Head Coach", placeholder: "Coach Martinez" },
    {
      key: "trainers",
      label: "Athletic Trainer",
      placeholder: "Yes - available on-site",
    },
    {
      key: "contact",
      label: "Contact",
    ...
    },
    {
      ...
      placeholder: "AD Office: 555-987-6543",
    },
    ...
    // === POLICIES ===
    {
      ...
      placeholder:
        "Lightning = shelter for 30 min. Heavy rain = practice moves indoors.",
      type: "textarea",
    },
  ],
  prefill: {
    title: "Varsity Football Practice",
    details:
      "Regular weekday practice. All players expected unless excused. Come ready to compete. Parents - please be on time for pickup. Go Panthers! 🏈",
    rsvpEnabled: false,
  },
  rsvpCopy: {
    menuTitle: "Attendance",
    menuDesc: "Track who's coming to practice.",
    editorTitle: "Attendance Check",
    toggleLabel: "Enable attendance confirmation",
    deadlineLabel: "Confirm by",
    helperText: "Players can confirm attendance before practice.",
  },
  themes: [
    {
      id: "friday_night",
