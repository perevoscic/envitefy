...
export const metadata: Metadata = {
  ...
  manifest: "/manifest.webmanifest?v=v14",
  other: {
...
export default async function RootLayout({
  ...
  const organizationLd = {
    ...
    description:
      "Envitefy turns invites, flyers, PDFs, schedules, and cards made with Envitefy Create into hosted live event pages with RSVPs, calendar saves, maps, registry links, and gymnastics meet pages.",
