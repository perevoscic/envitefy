...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/favicon.ico?v=v4", sizes: "any" },
      { url: "/icons/icon-192.png?v=v4", sizes: "192x192", type: "image/png" },
      { url: "/icons/icon-512.png?v=v4", sizes: "512x512", type: "image/png" },
      {
        url: "/icons/maskable-icon-192.png?v=v4",
        sizes: "192x192",
        type: "image/png",
        rel: "mask-icon" as any,
      },
      {
        url: "/icons/maskable-icon-512.png?v=v4",
        sizes: "512x512",
        type: "image/png",
        rel: "mask-icon" as any,
      },
    ...
    apple: [
      { url: "/icons/apple-touch-icon-120.png?v=v4", sizes: "120x120" },
      { url: "/icons/apple-touch-icon-152.png?v=v4", sizes: "152x152" },
      { url: "/icons/apple-touch-icon-167.png?v=v4", sizes: "167x167" },
      { url: "/icons/apple-touch-icon-180.png?v=v4", sizes: "180x180" },
    ],
    shortcut: [{ url: "/favicon.ico?v=v4" }],
  },
  appleWebApp: {
    capable: true,
