          ...
          <div className="bg-gradient-to-tr from-fuchsia-500/15 via-sky-400/15 to-violet-500/15 rounded-3xl p-1">
            <div className="rounded-3xl bg-surface/80 backdrop-blur-sm p-10 pb-16 border border-border">
              ...
              <p className="mt-5 text-lg sm:text-xl text-foreground/80 max-w-3xl mx-auto">
                Your privacy matters. This page explains what data Snap My Date
              ...
              <div className="mt-8 text-left max-w-3xl mx-auto space-y-6 text-foreground/80">
                <section>
                  ...
                  <p className="mt-2">
                    Images you upload for OCR, minimal account details for
                    authentication, and usage data to improve the product.
                  </p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-foreground">
                  ...
                  <p className="mt-2">
                    To extract event details, generate calendar files, and
                    deliver features like Google/Outlook insertion.
                  </p>
                </section>
                <section>
                  <h2 className="text-xl font-semibold text-foreground">
                  ...
                  <p className="mt-2">
                    You can request deletion of your account data and revoke
                    access to connected providers at any time.
                  </p>
                </section>
              </div>
