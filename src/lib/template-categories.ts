...
export const TEMPLATE_CATEGORIES = [
  {
    ...
    name: "Weddings",
    intent: "weddings",
    historyCategory: "Weddings",
    editor: "/event/weddings/customize",
  },
  {
    slug: "birthdays",
    name: "Birthdays",
    intent: "birthdays",
    historyCategory: "Birthdays",
    editor: "/event/birthdays/customize",
  },
  {
    slug: "anniversaries",
    name: "Anniversaries",
    intent: "anniversaries",
    historyCategory: "Anniversaries",
    editor: "/event/anniversaries/customize",
  },
  {
    slug: "baby-showers",
    name: "Baby showers",
    intent: "baby_showers",
    historyCategory: "Baby Showers",
    editor: "/event/baby-showers/customize",
  },
  {
    slug: "bridal-showers",
    name: "Bridal showers",
    intent: "bridal_showers",
    historyCategory: "Bridal Showers",
    editor: "/event/baby-showers/customize",
  },
  {
    slug: "gender-reveal",
    ...
    historyCategory: "Gender Reveal",
    editor: "/event/gender-reveal/customize",
  },
  {
    slug: "gymnastics",
    name: "Gymnastics",
    intent: "gymnastics",
    historyCategory: "Gymnastics",
    editor: "/event/gymnastics/customize",
  },
  {
    slug: "sport-events",
    name: "Sports",
    intent: "sport_events",
    historyCategory: "sport_event",
    editor: "/event/sport-events/customize",
  },
  {
    slug: "signup-forms",
    name: "Signup forms",
    intent: "signup_forms",
    historyCategory: "Smart sign-up",
    editor: "/templates/signup",
  },
] as const;
...
export function getTemplateCategory(slug: string) {
  return TEMPLATE_CATEGORIES.find(
    (category) => category.slug === (["sports", "football"].includes(slug) ? "sport-events" : slug),
  );
}
