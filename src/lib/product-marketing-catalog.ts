      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "New accounts start with creation tools for the category they signed up from. Gymnastics coaches see Gymnastics; football staff see Football, with that sport already selected. Snap, Upload and sign-up forms remain available, and hosts can enable other categories in Settings. Email and Google signup use the same category defaults.",
      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "The Football landing page pairs five distinct hero photos with matching headlines and planning tips for teams and families. Visitors can pause or navigate the slideshow, and reduced-motion preferences start it paused.",
            "Football has a dedicated public page and Create Event sidebar entry. Its searchable design gallery uses responsive masonry cards, automatic loading, and a back-to-top control; All 60 designs have individual football hero artwork, coordinated palettes and typography, and cinematic, poster, editorial, or split hero layouts shared by the gallery, editor, and event page. The collection includes coastal watercolor, mountain and desert fields, winter and rain games, women’s football, youth flag football, homecoming, marching band, tailgate, chrome, linocut, and paper-craft artwork. The gallery and design picker lead with a curated mix of team, heritage, stadium, and illustrated scenes; image-led thumbnails use compact title panels, readable card-relative typography, and intentional photo framing. Headlines are editable from the customization menu, with immediate preview updates. Uploaded team photos remain intact when changing designs. Category editors provide a labelled Change hero image control, including when an image is already selected; images remain in memory until explicit save.",
            "Football builders import uploaded schedules or public website URLs into the current editor, preserving the selected design and custom hero without creating a draft until explicit save. Game cards show one matchup heading using confirmed team mascots, prominent supplied dates, home/away status, stadium names, away-game directions, individual calendar actions and verified ticket links. Street addresses stay out of the card text while remaining available to directions and calendar entries. The schedule opens on upcoming games, with past results and dates awaiting confirmation in separate accessible tabs. Past game cards show only the matchup, date and supplied score, or Score unavailable when no score was supplied; desktop cards use two columns and mobile cards one. Ticket buttons open the hosting school's official sales page, including Hudl or GoFan where verified, with game selection on school-wide portals. Stadiums and tickets populate before driving calculations, and successful results stay visible if another lookup fails. Available road mileage from the home stadium and near-term weather can be refreshed when verified addresses and configured providers support them. Unprovided details stay hidden. Specialized sports builders structure schedules, team details and attendance information.",
