      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "Opening an owned Live Card or flyer/invitation from My Events goes directly to its Design editor. Artwork previews keep the card's own proportions without device controls. Event pages open in the full event view with Edit, Share, Delete and device controls. The collapsible sidebar and guest-response dashboards remain available; deletion returns to My Events.",
