      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "Event-page previews offer desktop, iPad/tablet, and mobile device icons to check responsive layouts before sharing. The controls are available in owner previews and Concierge, with Close returning to the workspace. Event previews extend one continuous event background across the screen with a transparent device toolbar, without restarting the artwork at the preview edges.",
      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "Football builders import uploaded schedules or public website URLs into the current editor, preserving the selected design and custom hero without creating a draft until explicit save. Game cards show one matchup heading using confirmed team mascots, prominent supplied dates, home/away status, stadium names, away-game directions, individual calendar actions and verified ticket links. Street addresses stay out of the card text while remaining available to directions and calendar entries. The schedule opens on upcoming games, with past results and dates awaiting confirmation in separate accessible tabs; desktop cards use two columns and mobile cards one. Ticket buttons open the hosting school's official sales page, including Hudl or GoFan where verified, with game selection on school-wide portals. Stadiums and tickets populate before driving calculations, and successful results stay visible if another lookup fails. Available road mileage from the home stadium and near-term weather can be refreshed when verified addresses and configured providers support them. Unprovided details stay hidden. Specialized sports builders structure schedules, team details and attendance information.",
