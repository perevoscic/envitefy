      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "Cards show Share in the upper-left corner and an eye button for a full-screen preview on a dark background. Share stays greyed out until the card is published and current changes are saved. Preview remains available while event details are incomplete and reuses existing artwork; Review prepares the finished title lettering. Save and Publish sit directly below the Live Card, including in full-screen Preview and Review on phones. Publish prepares and publishes the card directly through a full-screen animated progress view showing its current stage. Hosts can cancel preparation and keep editing before saving begins. Specific errors explain what needs attention without losing event details. Hosts can also use the Review step before publishing.",
