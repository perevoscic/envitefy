      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "A narrow, centered chat composer keeps separate microphone and Send buttons visible. Supported browsers can dictate into the message for review before sending; product choices appear before the conversation starts, with Generate preview beneath the latest reply when details are ready.",
            "Cancel stops an in-progress chat response or draft artwork generation while keeping the current work. When idle, Cancel returns to the dashboard through the existing unsaved-progress choices; publishing and saved-event updates finish before leaving.",
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "Category pages such as /weddings and /birthdays offer templates; creation CTAs for Envitefy Create open /chat, while introductions link to /envitefy-create.",
