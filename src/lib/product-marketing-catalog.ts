      ...
      features: [
        ...
        },
        {
          ...
          proofPoints: [
            ...
            "Hosts enter only a venue name. Addresses and local time zones are resolved in the background during final card preparation. A clear match fills the details; ambiguous matches offer choices. City or address clarification appears only when the venue cannot be identified. During Review, OpenAI draws the title and optional opening line into the artwork with expressive lettering suited to the design. Changing logistics reuses the finished title artwork.",
