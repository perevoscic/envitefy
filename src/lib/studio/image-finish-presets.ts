...
> = {
  Birthday: [
    ...
    {
      label: "Space Quest",
      description: "cosmic galaxy mission with starfield, planets, and astronaut adventure energy",
    },
    {
      label: "Unicorn Dust",
      description: "iridescent pastels, holographic glitter, magical unicorn whimsy",
    },
    {
      label: "Superhero Comic",
      description: "halftone comic-book panels, action-packed superhero ink and pop colors",
    },
    {
      label: "Safari Explorer",
      description: "warm savanna sunset, adventure expedition props, friendly safari wildlife",
    },
    {
      label: "Dino Jungle",
      description:
        "lush prehistoric jungle, playful dinosaur party styling, leafy adventure energy",
    },
  ],
  "Game Day": [
    ...
    {
      label: "Tailgate Glow",
      description: "sunset parking-lot tailgate energy with warm grill light and pennant flags",
    },
    {
      label: "Halftime Hype",
      description: "marching band brass, drumline rhythm, mid-game pep-rally electricity",
    },
    {
      label: "Locker Room Grit",
      description: "moody locker-room contrast, raw athletic textures, pre-game focus",
    },
    {
      label: "Championship Gold",
      description: "trophy-glow gold accents, confetti rain, victory-lap celebration polish",
    },
  ],
  Wedding: [
    ...
    {
      label: "Coastal Elopement",
      description: "ocean-side breeze, salt-air linen, barefoot beach ceremony romance",
    },
    {
      label: "Garden Estate",
      description: "lush manicured gardens, climbing florals, statuesque estate elegance",
    },
    {
      label: "Vintage Veil",
      description: "heirloom lace, antique stationery, soft sepia heritage romance",
    },
    {
      label: "Modern Monochrome",
      description: "architectural lines, crisp black-tie minimalism, gallery-grade contrast",
    },
  ],
  "Open House": [
    {
      label: "Luxury Listing",
      description: "high-end brokerage polish, crisp hierarchy, premium listing flyer contrast",
    },
    {
      label: "Architectural Editorial",
      description: "magazine-style architecture, generous spacing, refined real-estate typography",
    },
    {
      label: "Sunset Curb Appeal",
      description: "warm exterior glow, polished curb appeal, inviting open-house atmosphere",
    },
    {
      label: "Modern Brokerage",
      description:
        "clean agent-forward layout, contemporary listing presentation, confident contrast",
    },
    {
      label: "Minimal MLS",
      description:
        "restrained MLS-style facts, white space, precise listing details, elegant structure",
    },
    {
      label: "Magazine Feature",
      description: "feature-spread collage, one dominant property hero, premium lifestyle accents",
    },
  ],
  "Bridal Shower": [
    ...
    {
      label: "Cottage Romance",
      description: "cozy cottage florals, hand-tied bouquets, hostess-pampered styling",
    },
    {
      label: "Tropical Bride",
      description: "lush palm fronds, hibiscus brights, beach-club bridal energy",
    },
    {
      label: "Boho Lace",
      description: "macramé textures, pampas grass, sun-washed boho bridal poetry",
    },
    {
      label: "City Soirée",
      description: "rooftop skyline glamour, neon-lit cocktails, modern downtown bridal night",
    },
  ],
  "Baby Shower": [
    ...
    {
      label: "Little Safari",
      description: "soft jungle pals, woven textures, playful safari nursery cues",
    },
    {
      label: "Twinkle Stars",
      description: "midnight blue, glowing constellations, bedtime nursery magic",
    },
    {
      label: "Woodland Hush",
      description: "muted forest greens, fox and bunny accents, storybook woodland calm",
    },
    {
      label: "Sweet Sherbet",
      description: "creamy peach, mint, and lavender sherbet hues with airy garlands",
    },
  ],
  "Field Trip/Day": [
    ...
    {
      label: "Museum Wonder",
      description: "polished gallery lighting, exhibit signage, curious museum-quest energy",
    },
    {
      label: "Trail Trek",
      description: "backpack-ready trail textures, leafy canopy, junior-ranger expedition mood",
    },
    {
      label: "Science Lab",
      description: "bright lab beakers, periodic-table accents, hands-on STEM discovery vibe",
    },
    {
      label: "City Discovery",
      description: "skyline backdrops, transit map textures, downtown field-trip pace",
    },
  ],
  Anniversary: [
    ...
    { label: "Evening Elegance", description: "moody, elevated, luxurious" },
    {
      ...
      description: "polished silver shimmer, crystal toast, milestone-anniversary refinement",
    },
    {
      label: "Vintage Romance",
      description: "sepia photo edges, old-world script, decades-of-love nostalgia",
    },
    {
      label: "Garden Renewal",
      description: "rose garden lattice, vow-renewal blossoms, tender afternoon glow",
    },
    {
      label: "Ballroom Glow",
      description: "grand ballroom chandeliers, mirrored toasts, formal anniversary glamour",
    },
  ],
  Housewarming: [
    ...
    {
      label: "Garden Patio",
      description: "string-light patio, potted greenery, golden-hour backyard hosting",
    },
    {
      label: "Loft Industrial",
      description: "exposed brick, edison bulbs, modern-loft housewarming polish",
    },
    {
      label: "Mid-Century Bright",
      description: "walnut warmth, mustard accents, mid-century styled hosting",
    },
    {
      label: "Coastal Cottage",
      description: "breezy linens, weathered woods, calming coastal welcome",
    },
  ],
  "Custom Invite": [
    ...
    {
      label: "Retro Throwback",
      description: "vintage poster typography, halftone dots, nostalgic event flair",
    },
    {
      label: "Luxe Noir",
      description: "midnight black, gold foil accents, after-dark formal mystery",
    },
    {
      label: "Hand-Drawn Charm",
      description: "loose ink illustrations, watercolor washes, personal hand-crafted warmth",
    },
    {
      label: "Festival Pop",
      description: "high-energy festival posters, layered patterns, crowd-ready brights",
    },
  ],
};
