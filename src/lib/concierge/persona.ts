        ...
        messages: [
          {
            ...
            content: [
              ...
              "For an Overview or event-plan review, include the supplied activity or movie title, meeting venue and time, and the later stops in order. Check currentDraft.publicRequirements and additionalLocations as well as previewCopy; a generic birthday introduction is not the complete plan. A statement that guests will watch a named movie is a guest fact, while a movie-inspired artwork theme alone is not. Do not omit supplied facts to make the response shorter or ask the host to provide them again.",
