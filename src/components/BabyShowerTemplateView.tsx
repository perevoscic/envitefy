...
import BabyShowerDesignHero, {
  babyShowerDesignStyle,
} from "@/components/baby-showers/BabyShowerDesignHero";
...
import {
  getBabyShowerDesign,
  getBabyShowerTheme,
  isBabyShowerDesignDark,
  resolveBabyShowerHero,
} from "@/lib/baby-shower-designs";
import {
...
export default function BabyShowerTemplateView({
  ...
  const heroImage = isBridal
    ? eventData?.heroImage || DEFAULT_HERO_IMAGE
    : resolveBabyShowerHero(eventData?.heroImage, design);
  ...
  return (
    <main
      className={design ? babyStyles.page : "event-modern-page font-sans text-slate-900"}
      style={design ? babyShowerDesignStyle(design) : undefined}
    >
        ...
        <div className={design ? "w-full" : "mx-auto flex w-full max-w-5xl flex-col py-6 md:py-10"}>
          <div
            className={
              design
                ? babyStyles.shell
                : `relative overflow-hidden rounded-[32px] shadow-[0_35px_120px_rgba(15,23,42,0.25)] ${backgroundClass}`
            }
          ...
          >
            {isBridal ? (
              <BridalShowerPreview
                ...
                data={{ ...eventData, theme, images: { hero: heroImage } }}
              />
            ) : design ? (
                  ...
                  !isReadOnly && (canEdit || isOwner) ? (
                    <>
                      {canEdit && (
                        <Link
                          href={editHref}
                          className="rounded-full border border-current px-4 py-2 text-xs"
                        >
                          Edit
                        </Link>
                      )}
              ...
              <>
                ...
                <div className="relative h-[420px] w-full">
                  <TemplateImageTone
                    enabled={eventData.heroImageFilterEnabled !== false}
                    color={theme.accent}
                  >
                    <img
                      src={heroImage}
            ...
            <div className={design ? babyStyles.body : undefined} data-style={design?.style}>
              ...
              {!thumbnail && navItems.length > 0 && (
                <nav
                  className={
                    design
                      ? undefined
                      : "border-t border-white/10 bg-white/80 px-4 py-3 backdrop-blur-lg"
                  }
                >
                      ...
                      <a
                        ...
                        className={
                          design
                            ...
                            : "rounded-full border border-slate-200 px-4 py-2 text-xs font-semibold uppercase tracking-[0.4em] text-slate-600 transition hover:border-slate-400 hover:text-slate-900"
                        }
              ...
              <span id="details" />
              <TemplateBodyLayout
                design={!isBridal ? { category: "baby-showers", id: design?.id } : undefined}
                presentation={getTemplateBodyPresentation(
                  isBridal ? "bridal-showers" : "baby-showers",
                  isBridal ? eventData.templateId : design?.id,
                )}
              >
                {!isBridal &&
                      ...
                      {!rsvpSubmitted ? (
                        ...
                        <div className="text-center py-12">
                          ...
                          <p className="opacity-70">
                            {preview
                              ? "Preview response recorded. Publish your invitation to receive guest RSVPs."
