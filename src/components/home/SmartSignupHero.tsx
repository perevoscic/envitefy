        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-center">
            <Link
              ...
              className="inline-fle items-center justify-center rounded-full bg-[#3975C3] px-6 py-3 text-base font-semibold text-white shadow-lg shadow-[#3975C3]/40 transition hover:-translate-y-0.5 sm:w-auto"
            >
