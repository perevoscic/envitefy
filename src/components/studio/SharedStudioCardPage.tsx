...
export default function SharedStudioCardPage(props: SharedStudioCardProps) {
  ...
  const closeButtonLeft = posterFirstHeroCard
    ? "min(calc(50vw + min(calc(100vw - 2rem), calc((100dvh - 6.5rem - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px)) * 2 / 3)) / 2 + 0.75rem), calc(100vw - 3.75rem))"
    : "min(calc(50vw + min(calc(100vw - 2rem), calc((100dvh - 6.5rem - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px)) * 9 / 16)) / 2 + 0.75rem), calc(100vw - 3.75rem))";
