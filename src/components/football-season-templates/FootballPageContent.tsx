...
} from "@/components/events/EventSectionBuilder";
...
export default function FootballPageContent({
  ...
  return (
    <EventSectionCanvas
      className={`${chrome.presentationClass || ""} ${styles.canvas}`}
            ...
            >
              <div className={styles.sectionHeader}>
                <div className={styles.headingGroup}>
                  {section.eyebrow ? (
                    <p className={`${styles.eyebrow} ${chrome.accentClass}`}>
                      <FootballText
              ...
              <div className={styles.sectionBody}>
                ...
                {section.id === "scores" ? (
                  ...
                  <FootballSchedule
                    {...schedule}
                    cardClassName={chrome.sectionCardClass}
                    navigationClassName={chrome.navShellClass}
                    activeTabClassName={chrome.navActiveClass}
                    idleTabClassName={chrome.navIdleClass}
                  />
