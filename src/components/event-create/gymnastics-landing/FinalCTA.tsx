...
export default function FinalCTA({ discoveryBusy, onGoToStart }: FinalCTAProps) {
  return (
    <section className="px-4 pb-24 pt-18 sm:px-6 lg:px-8 lg:pb-28 lg:pt-24">
      <div className={`${styles.container} overflow-hidden rounded-[2.6rem] border border-[#d8deec] bg-[linear-gradient(135deg,#171b46_0%,#1e2258_58%,#27306f_100%)] px-8 py-10 text-white shadow-[0_34px_90px_rgba(23,27,70,0.22)] sm:px-10 lg:px-12 lg:py-14`}>
