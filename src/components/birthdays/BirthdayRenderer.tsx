...
export default function BirthdayRenderer({
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (stored) setUserRsvpResponse(stored);
    } catch {}

    const handler = (e: Event) => {
      const detail = (e as CustomEvent).detail;
      if (detail?.eventId === eventId && detail?.response) {
        setUserRsvpResponse(detail.response);
      } else if (!detail?.eventId && eventId) {
        try {
          const stored = localStorage.getItem(`envitefy_rsvp_${eventId}`);
          if (stored) setUserRsvpResponse(stored);
        } catch {}
      ...
      >
        ...
        {showHostDashboard && eventId && (
          <div className="max-w-4xl mx-auto w-full px-6 pb-20 mt-12">
            <EventRsvpDashboard
              eventId={eventId}
              initialNumberOfGuests={event.numberOfGuests || 0}
            />
          </div>
        )}
      ...
      >
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 flex flex-col items-center">
          <div className="bg-white/90 p-8 md:p-12 rounded-[2rem] shadow-2xl border-4 border-dashed border-slate-200 text-center transform -rotate-1">
            ...
            <h1
              className="text-4xl md:text-7xl font-black mb-8 leading-[1.1] tracking-tight px-4"
              style={{
...
function GlamorousSparkleLayout({
  theme,
  event,
  actions,
  onRsvpClick,
      ...
      <header className="relative w-full h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1 text-center md:text-left">
            <span
              className="inline-block px-6 py-2 rounded-full border-2 font-bold tracking-[0.2em] uppercase text-xs mb-6"
              style={{
            ...
            <h1
              className="text-6xl md:text-8xl font-light mb-8 italic"
              style={{
                fontFamily: theme.fonts.headline,
                color: theme.colors.secondary,
              }}
    ...
    >
      ...
      <section className="relative z-10 pt-20 pb-12 px-6 flex flex-col items-center">
        ...
        <div className="mb-12 text-center">
          ...
          <h1
            className="text-6xl md:text-8xl font-medium mb-4 italic"
            style={{
              fontFamily: theme.fonts.headline,
              color: theme.colors.secondary,
            }}
  ...
  return (
    <>
      ...
      >
        ...
        ></div>
        <div
          className="absolute bottom-1/4 right-1/4 w-64 h-64 rounded-full blur-[100px] opacity-20 animate-pulse"
          style={{ backgroundColor: isPixel ? "#ff00ff" : "#d946ef" }}
        ></div>
        ...
        <div className="relative z-10 text-center border-4 border-white/10 p-10 md:p-16 backdrop-blur-sm bg-black/20 max-w-3xl mx-4">
          <div
            className="absolute inset-0 border-2 scale-[1.02] -z-10 animate-pulse"
            style={{ borderColor: `${theme.colors.secondary}80` }}
          ></div>
          <h1
            className="text-5xl md:text-8xl font-black tracking-tighter uppercase mb-6 drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]"
            style={{
              fontFamily: theme.fonts.headline,
              textShadow: `0 0 20px ${theme.colors.secondary}`,
              color: "#fff",
            }}
          >
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-2xl px-6">
          ...
          <div className="flex items-center justify-center gap-4 text-slate-600 mt-4">
            <span
              className="uppercase tracking-widest text-sm border-b pb-1"
    ...
    <>
      ...
      >
        ...
        <div className="w-full max-w-4xl mx-auto grid md:grid-cols-2 gap-8 items-center px-6">
          <div className="order-2 md:order-1 text-center md:text-left">
            <span
              className="uppercase tracking-[0.3em] text-xs font-bold mb-3 block"
...
function PixelArcadeLayout({
  ...
  return (
    <>
      <section
        className="relative w-full py-16 flex flex-col items-center justify-center bg-zinc-900 border-b-4 border-dashed"
        style={{
          borderColor: theme.colors.secondary,
          backgroundColor: theme.colors.primary,
        }}
      >
        ...
        <div
          className="relative z-10 border-4 p-8 max-w-2xl text-center bg-black/40 backdrop-blur-md shadow-[8px_8px_0px_0px_rgba(0,0,0,0.5)]"
          style={{
            borderColor: theme.colors.secondary,
            boxShadow: `8px 8px 0px 0px ${theme.colors.secondary}`,
          }}
        >
          ...
          <h1
            ...
            style={{
              ...
              textShadow: `4px 4px 0px ${theme.colors.secondary}`,
            }}
          >
...
function ElegantSerifLayout({
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex flex-col items-center pt-16 pb-16 px-6">
      {actions && <div className="absolute top-4 right-4 z-50">{actions}</div>}
      <div
        className="w-full max-w-2xl bg-white p-12 shadow-2xl relative border"
        style={{ borderColor: theme.colors.secondary }}
      >
        {/* Gold Frame Effect */}
        <div
          className="absolute inset-2 border double-border pointer-events-none"
          style={{ border: `1px solid ${theme.colors.secondary}` }}
        ></div>
        <div
          className="absolute inset-3 border pointer-events-none opacity-50"
          style={{ border: `1px solid ${theme.colors.secondary}` }}
        ></div>
        ...
        <div className="text-center relative z-10 space-y-8">
          ...
          <h1
            className="text-6xl md:text-7xl playfair italic"
            style={{
              color: theme.colors.secondary,
              fontFamily: theme.fonts.headline,
            }}
...
function CosmicAdventureLayout({
  theme,
  event,
  actions,
  onRsvpClick,
  ...
  return (
    <div className="bg-black text-white min-h-screen relative overflow-hidden flex flex-col">
      ...
      {/* Stars/Dust */}
      <div
        className="absolute inset-0 opacity-40 animate-[pulse_4s_ease-in-out_infinite]"
        style={{
      ...
      <section className="relative z-10 min-h-[60vh] flex flex-col items-center justify-center p-6">
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 p-10 rounded-full w-[300px] h-[300px] md:w-[500px] md:h-[500px] flex flex-col items-center justify-center text-center shadow-[0_0_100px_rgba(255,255,255,0.1)] relative">
          ...
          <span className="text-cyan-400 tracking-[0.5em] text-xs font-bold uppercase mb-4">
            Incoming Transmission
          </span>
          <h1
            className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 mb-6"
            style={{ fontFamily: theme.fonts.headline }}
          >
...
function AnimalPartyLayout({
  ...
  return (
    ...
    >
      ...
      {/* Soft Pastel Shapes */}
      <div
        className="absolute top-0 left-0 w-64 h-64 rounded-full opacity-30 blur-3xl -translate-x-1/2 -translate-y-1/2"
        style={{ backgroundColor: theme.colors.secondary }}
      ></div>
      <div
        className="absolute bottom-0 right-0 w-96 h-96 rounded-full opacity-20 blur-3xl translate-x-1/3 translate-y-1/3"
        style={{ backgroundColor: theme.colors.secondary }}
      ></div>
      ...
      <div className="max-w-4xl mx-auto pt-12 px-6 pb-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-8">
            ...
            <div
              className="bg-white p-8 md:p-12 shadow-sm rounded-lg border-l-8"
              style={{ borderColor: theme.colors.secondary }}
            >
              <BirthdayContentSections
                theme={theme}
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 shadow-md rounded-lg text-center font-mono">
              <span className="text-xs text-slate-400 block mb-2 font-sans font-bold uppercase tracking-widest">
                Base Location
              </span>
...
function UnderwaterAdventureLayout({
  theme,
  event,
  actions,
  onRsvpClick,
  ...
  return (
    <div
      className="min-h-screen bg-sky-50 overflow-hidden relative"
      style={{ backgroundColor: theme.colors.primary }}
    >
      {actions && <div className="absolute top-4 right-4 z-50">{actions}</div>}
      ...
      <div className="max-w-5xl mx-auto px-6 pt-20 pb-20 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-12 mb-20">
          <div className="flex-1 text-center md:text-left">
            <div
              className="w-16 h-1 w-full md:mx-0 mx-auto bg-sky-300 mb-6"
              style={{ backgroundColor: theme.colors.secondary }}
            ></div>
            <h1
              className="text-6xl md:text-8xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-b from-sky-900 to-sky-700"
              style={{
                fontFamily: theme.fonts.headline,
                color: theme.colors.secondary,
              }}
...
function PatternPlayLayout({
  ...
  return (
    <div
      className="min-h-screen border-[12px] border-white relative"
      style={{
        backgroundColor: theme.colors.primary,
      ...
      <div className="max-w-4xl mx-auto pt-20 px-4 pb-20">
        <div className="bg-white p-2 shadow-xl rotate-1 max-w-lg mx-auto mb-16 transform hover:rotate-0 transition-transform duration-300">
          ...
          <div className="p-8 text-center pb-12">
            <h1
              className="text-5xl font-bold mb-2 transform -rotate-2"
              style={{
                fontFamily: theme.fonts.headline,
                color: theme.colors.secondary,
              }}
...
function BirthdayContentSections({
  theme,
  event,
  backgroundColor,
  darkMode = false,
  ...
  return (
    <main
      className="w-full max-w-4xl mx-auto px-6 py-12 space-y-12"
    ...
    >
      ...
      {(childName || age || time || partyTheme) && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {childName && (
            <div
              className={`p-4 rounded-2xl ${sectionBg} border ${
                darkMode ? "border-white/10" : "border-white/20"
              } text-center flex flex-col justify-center min-h-[100px]`}
            >
          ...
          {time && (
            ...
            >
              ...
              <p className="font-bold text-lg" style={{ color: headingColor }}>
                {time}
              </p>
            </div>
          )}
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        {event.story && (
          <section
            className={`p-8 rounded-[2rem] ${sectionBg} backdrop-blur-sm border ${
          ...
          >
            ...
            <p className="leading-relaxed opacity-90 text-lg">{event.story}</p>
          </section>
        )}
            ...
            {event.schedule.map((item, idx) => (
              <div
                ...
                className={`p-6 rounded-2xl ${
                  darkMode ? "bg-white/5" : "bg-white/80 shadow-sm"
                } border ${
        ...
        <section>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {event.gallery.map((photo, idx) => (
              <div
                key={idx}
                className={`w-48 aspect-square rounded-[2rem] overflow-hidden shadow-xl border-4 border-white ${
        ...
        <section className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {event.hosts.map((host, idx) => (
              <div
                key={idx}
                className={`px-8 py-4 rounded-full ${sectionBg} border ${
                  darkMode ? "border-white/10" : "border-white/50"
...
function EditorialFeatureLayout({
  ...
  const summary =
    event.story ||
    (formattedDate
      ? `Celebrate with us on ${formattedDate}${
          ...
          <div
            className={`relative overflow-hidden ${
              useUploadedFlyerHero
                ? "min-h-[320px] p-6 md:flex md:min-h-full md:items-center md:justify-center md:p-10"
...
function EditorialStatCard({
  ...
  return (
    <div
      className={`rounded-[1.2rem] sm:rounded-[1.5rem] bg-[#eef3f8] p-4 sm:p-6 shadow-[0_10px_26px_rgba(120,110,160,0.08)] ${
        className ?? ""
      }`}
    >
      ...
      <p className="mt-1 sm:mt-2 text-base sm:text-lg font-black leading-6 text-slate-800">
        {value}
      </p>
    </div>
  );
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col">
      <section className="relative w-full h-[500px] overflow-hidden bg-green-700 flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-6">
          <div
            className="inline-block px-6 py-2 bg-orange-500 font-black text-xl italic uppercase tracking-tighter transform skew-x-[-15deg] mb-6 shadow-xl"
            style={{ backgroundColor: theme.colors.secondary }}
          >
            All Star Birthday
          </div>
          <h1
            className="text-6xl md:text-9xl font-black uppercase italic tracking-tighter drop-shadow-[0_4px_0_rgba(0,0,0,0.5)]"
            style={{ fontFamily: theme.fonts.headline }}
          >
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border-b-4 border-slate-200">
              ...
              <p className="text-2xl font-black italic text-slate-800 uppercase line-clamp-1">
                {event.location}
              </p>
            </div>
          </div>
...
function LuxuryRoyalLayout({
  ...
  return (
    <div
      className="min-h-screen bg-[#0d1b33] text-[#e0c097] flex flex-col"
      style={{ backgroundColor: theme.colors.primary }}
    >
      <section className="relative h-[80vh] flex flex-col items-center justify-center p-6 border-b border-[#e0c097]/10">
        ...
        <div className="relative z-10 text-center max-w-4xl">
          <div
            className="w-16 h-px bg-[#e0c097] mx-auto mb-8"
            style={{ backgroundColor: theme.colors.secondary }}
          ></div>
          <span className="text-xs uppercase tracking-[0.5em] mb-4 block font-medium">
            Cordially Invited
          </span>
          <h1
            className="text-4xl md:text-7xl font-serif mb-8 italic leading-tight px-4"
            style={{
              fontFamily: theme.fonts.headline,
              color: theme.colors.secondary,
            }}
    ...
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: theme.colors.primary }}>
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <h1
            className="text-7xl md:text-9xl font-black italic tracking-tighter uppercase"
            style={{
              fontFamily: theme.fonts.headline,
              color: theme.colors.secondary,
            }}
...
function SafariAdventureLayout({
  theme,
  event,
  actions,
  onRsvpClick,
  ...
  return (
    <div
      className="min-h-screen bg-[#fdfaf3] flex flex-col"
      style={{ backgroundColor: theme.colors.primary }}
    >
      <section className="relative pt-24 pb-12 px-6 flex flex-col items-center">
        ...
        <div className="max-w-4xl w-full bg-[#f4e7d3] p-12 md:p-20 border-[16px] border-[#5d4037] relative shadow-2xl overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <span className="text-xs font-black uppercase tracking-[0.6em] text-amber-900 mb-6 block">
              Jungle Expedition
            </span>
            <h1
              className="text-6xl md:text-8xl font-black uppercase mb-8 leading-none"
              style={{
                fontFamily: theme.fonts.headline,
                color: theme.colors.secondary,
              }}
            ...
            <div className="flex flex-col items-center gap-2 font-mono text-amber-900">
              <p className="text-2xl font-bold bg-amber-900 text-amber-100 px-6 py-2">
