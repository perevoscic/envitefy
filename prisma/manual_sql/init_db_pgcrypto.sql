...
-- Private OCR troubleshooting records. Preview bytes are only served by admin-authenticated routes.
...
-- First-party event/link tracking for public event pages and outbound actions
